...
Κανόνες:
- Μείνε μόνο σε θέματα διατροφής, ευεξίας, fitness, προπόνησης και υγιεινών συνηθειών.
- Δώσε πρακτική, σύντομη και ασφαλή απάντηση.
- Αν η ερώτηση ζητά συνταγή, δώσε υλικά, σύντομα βήματα και ενδεικτικές θερμίδες/macros όπου γίνεται.
- Αν η ερώτηση ζητά άσκηση, δώσε ασκήσεις, σετ, επαναλήψεις, ξεκούραση και βασική τεχνική.
...
function sendGeminiError(res, providerStatus, providerError) {
  ...
  if (errorCode === "invalid_api_key") {
    ...
    error = "Το αίτημα προς το Gemini API δεν έγινε δεκτό. Έλεγξε το GEMINI_MODEL.";
