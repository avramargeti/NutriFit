...
class _FitnessProgramsScreenState extends State<FitnessProgramsScreen> {
  ...
  void _addToPlan(String programName) {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Το πρόγραμμα "$programName" προστέθηκε στο πλάνο!'), backgroundColor: sageGreen));
  }
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ElevatedButton(onPressed: () => _addToPlan(data['name']), child: const Text('Προσθήκη στο Πλάνο')),
                                ],
                              ),
                            ),
                          );
