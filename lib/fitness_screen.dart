        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              onPressed: () => _showComingSoon('Κουίζ Προτιμήσεων'),
            ),
            const SizedBox(height: 15),

            // Mockup of the View All Button
            OutlinedButton.icon(
            ...
            // Static dummy list to populate the UI
            Row(
              children: [
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(calories, style: const TextStyle(fontWeight: FontWeight.bold, color: Colors.redAccent)),
            const SizedBox(height: 15),
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: const Text('Προσθήκη στο Πλάνο', style: TextStyle(fontWeight: FontWeight.bold)),
              ),
            ),
          ],
        ),
